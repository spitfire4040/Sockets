...
# function: transfer routing info
...
def routing_table():
	...
	# global variables
	global NID, l1_NID, l2_NID, l3_NID, l4_NID
	global l1_flag, l2_flag, l3_flag, l4_flag
	...
	while(1):
		...
		if l1_flag == True:
			if l1_NID != 0:
				...
				textfile = '/home/jthom/Sockets/' + NID + '-paths' + '/rt-' + l1_NID + '.txt'
				rt = open(textfile, "w")				
				rt.write(l1_NID + '\t' + '1' + '\n')
				rt.close()
				transfer(textfile)
		...
		if l2_flag == True:
			if l2_NID != 0:
				# open text file for routing table
				textfile = '/home/jthom/Sockets/' + NID + '-paths' + '/rt-' + l2_NID + '.txt'
				rt = open(textfile, "w")				
				rt.write(l2_NID + '\t' + '1' + '\n')
				rt.close()
				transfer(textfile)
		...
		if l3_flag == True:
			if l3_NID != 0:
				# open text file for routing table
				textfile = '/home/jthom/Sockets/' + NID + '-paths' + '/rt-' + l3_NID + '.txt'
				rt = open(textfile, "w")				
				rt.write(l3_NID + '\t' + '1' + '\n')
				rt.close()
				transfer(textfile)
		...
		if l4_flag == True:
			if l4_NID != 0:
				# open text file for routing table
				textfile = '/home/jthom/Sockets/' + NID + '-paths' + '/rt-' + l4_NID + '.txt'
				rt = open(textfile, "w")				
				rt.write(l4_NID + '\t' + '1' + '\n')
				rt.close()
				transfer(textfile)
